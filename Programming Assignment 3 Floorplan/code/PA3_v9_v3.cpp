...
void Floorplanning::postorder(Node *ptr) {
    if(ptr) {
        postorder(ptr->left);
        postorder(ptr->right);
            // cout << "I'm " << ptr->data << " = " << ptr->blks[ptr->choosen].aspect.width << " * " << ptr->blks[ptr->choosen].aspect.height << endl;
            // if(ptr->left)
            // cout << "left is " << ptr->left->data << " = " << ptr->left->blks[ptr->left->choosen].aspect.width << " * " << ptr->left->blks[ptr->left->choosen].aspect.height << endl;
            // if(ptr->right)
            // cout << "right is " << ptr->right->data << " = " << ptr->right->blks[ptr->right->choosen].aspect.width << " * " << ptr->right->blks[ptr->right->choosen].aspect.height << endl;
            // cout << endl;
            cout << ptr->data << " ";
            // if(!ptr->update)
            // cout << "I'm " << ptr->data << " , I'm false" << endl;
    }
}
...
vector<string> Floorplanning::SA(vector<string> &spe) {
    ...
    cout << endl << fixed << setprecision(2) << "best : " << root->blks[0].aspect.width * root->blks[0].aspect.height << endl;
    postorder(root);
    cout << endl;
    cout<< "-----------------------------------------------------------" << endl;
    cout << endl;
...
void Floorplanning::bottom_up(Node *ptr) {
    ...
    if((ptr->data == "V" || ptr->data == "H") && ptr->update == false) {
        ...
        if(blks.size() > pts) {
            // vector<bool> valid(blks.size(), false);
